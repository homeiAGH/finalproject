            ...
            <div class="col-md-12">
                <div class="col-md-4 col-sm-4 col-xs-12 ">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="<?php echo base_url('User/create_user');?>"> Create User</a></li>
                    </ol>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="book_insert" class="form-horizontal form-label-left"
                            action="<?php echo base_url('User/new_user');?>" method="post"
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" id="username" autocomplete="off"
                                        value="<?php echo set_value("username")?>" name="username" class="form-control"
                                        placeholder="">
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" id="password" autocomplete="off"
                                        value="<?php echo set_value("password")?>" name="password" class="form-control"
                                        placeholder="">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <img id="imgprvw" width="150" height="120" src="" draggable="false"
                                        style="border: none;" />
