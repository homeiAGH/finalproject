            ...
            <div class="col-md-12">
                <div class="col-md-4 col-sm-4 col-xs-12 ">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href=""> Edit Drivers</a></li>
                    </ol>
                </div>
                <div class="col-md-8 col-sm-4 col-xs-12  " style="margin-top: 36px">

                    <?php if($msg=$this->session->flashdata('driver_edit_message')):?>
                    <div id="myalert"
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="" class="form-horizontal form-label-left"
                            action="<?php echo base_url('Driver/update_driver');?>" method="post"
                            enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="col-sm-6 col-xs-12">
                                    <label for="name">Name <span style="color:red">*</span></label>
                                    <input type="hidden" id="rowId" autocomplete="off"
                                        value="<?php echo set_value("rowId",$driver->id)?>" name="rowId">
                                    <input type="text" id="name" autocomplete="off"
                                        value="<?php echo set_value("name",$driver->name)?>" name="name"
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" id="lastname" autocomplete="off"
                                        value="<?php echo set_value("lastname",$driver->lastname)?>" name="lastname"
                                        class="form-control" placeholder="">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" id="Phone" autocomplete="off"
                                        value="<?php echo set_value("phone",$driver->phone)?>" name="phone"
                                        class="form-control" placeholder="">
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" id="password" autocomplete="off"
                                        value="<?php echo set_value("address",$driver->address)?>" name="address"
                                        class="form-control" placeholder="">
