        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-2 col-sm-4 col-xs-12 ">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="<?php echo base_url('Welcome/main_page')?>"><i class="fa fa-dashboard"></i>
                                Home</a></li>
                        <li class="active"><a href="<?php echo base_url('Car/index');?>"> Cars</a></li>
                    </ol>
                ...
                <div class="col-md-8 col-sm-4 col-xs-12  " style="margin-top: 36px">
                    ...
                    <?php elseif($msg=$this->session->flashdata('car_edit_message')):?>
                    <div id="myalert"
                    ...
                    <?php elseif($msg=$this->session->flashdata('car_delete_message')):?>
                    <div id="myalert"
                        class="alert pull-right <?=$this->session->flashdata('car_delete_message_alert_type')?> alert-dismissible fade in col-md-5 col-sm-3 col-xs-12 pull-right "
                        role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                                aria-hidden="true">×</span>
                        </button>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?=$counter?></td>
                                        <td><?php echo $car->palete ?></td>
                                        <td><?php echo $car->type_name; ?></td>
                                        <td>
                                            <a href="<?php echo base_url()."Car/edit_car/".$car->id?>"><button
                                            ...
                                            <button class="btn btn-xs btn-danger" type="button" data-toggle="tooltip"
                                                onclick='dlt_confirm("<?=$car->id?>")' title="Delete">
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel2">Delete Car</h4>
                    </div>
                    <div class="modal-body">

                        <form id="admin_delete" action="<?php echo base_url('Car/delete_car');?>" method="post"
